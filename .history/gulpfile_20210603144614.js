...
gulp.task('serve', gulp.parallel('less'), function () {
  ...
  gulp.watch('UKRC/less/*.less', gulp.parallel('less'));
  gulp.watch('UKRC/*.html').on('change', browserSync.reload);
  gulp.watch('UKRC/documents/*.html').on('change', browserSync.reload);
  gulp.watch('UKRC/js/*.js').on('change', browserSync.reload);
});
...
exports.default = function () {
  ...
  watch('UKRC/less/*.less', gulp.parallel('less'));
  watch('UKRC/*.html').on('change', browserSync.reload);
  watch('UKRC/documents/*.html').on('change', browserSync.reload);
  watch('UKRC/js/*.js').on('change', browserSync.reload);
};
// gulp.task('less', function () {
//   gulp
//     .src('less/*.less')
